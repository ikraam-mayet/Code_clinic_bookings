...
def display_cal(src_fn):
        ...
        a volunteer the it will be displayed in green. If the event has a 
        patient, volunteer meaning it is fully booked it will be displayed in 
        red and events with no attendees will be displayed in blue
        """
